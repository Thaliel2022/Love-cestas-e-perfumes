...
const HomePage = ({ onNavigate }) => {
    ...
    const categoryCards = [
        { name: "Perfumes Masculinos", image: "https://res.cloudinary.com/dvflxuxh3/image/upload/v1751853671/xbvlixkajn8ts3rjsfqq.jpg", filter: "Masculino" },
        { name: "Perfumes Femininos", image: "https://res.cloudinary.com/dvflxuxh3/image/upload/v1751853671/xbvlixkajn8ts3rjsfqq.jpg", filter: "Feminino" },
    ...
    return (
      <>
        <section className="relative h-[80vh] sm:h-[70vh] flex items-center justify-center text-slate-800 bg-gray-100">
          <div className="absolute inset-0 bg-cover bg-center opacity-30" style={{backgroundImage: "url('https://lh3.googleusercontent.com/fife/ALs6j_EJsYiofsh0dsZcEZUpewXJt510OqSValNDGz5VTkYM15_cAj5AZsRgmZ3lhcpPyJAF_IP622ocWvkim1iP3DGfVx3ma4cY_pBrStCZkGhsZu7X8Q_pC8qzv0XhrOoFD2PxKYkHKb0WxKJWCg-qYxeX3f1cfgefhb3tBk9euVHffdQaep_Ax_uWPouXTpAmLn2ByKR8dDkXvF8khKU92lZj-DoXZZPoYhDdgMe7yVlBT07g747bWhDIImhkN104PZprXhsgUMOgR54w5CeyrtkGjpArDVt01DXPFKFumQxNYKV2dzoG36czUF9b4CbRqZkeLh3iFobACSPg2EkgRS4FWlq18NTCRhWMY1MpauypJ2UTV_Ll3baWGPAGHFRx6hM3HY2T3ZZHNmnucizJTQ-CM2gMBgrkYG5_wdj1Sooyz_jfAR0druq5aFl65M9S6D-xp7tKK7Ot4-cG-RQA0JO8t9LBnFzU_Wbjfyea-s3r0EVz8wodB9G7GuDfJo_1jyQ_v3Rs64JXS7-IOLPmM5fkz1iUU2pFg-MLbS2gbYnkRMCifZ7xrAlp34eeJJQx1kcrZT-NDJSrHqFztX5xfirtRd3GzwEzFbxhwpEVI8ogEFI17IfNR6un0pEtD0tBfyf7okujdoTfOe0Rwo1Ezqs7q1HVjufz6ta5Dzp6zpMH9PTthR3JZ8O6ei127Pws1FkqPN3Q6FUpj4pA1fqQg2irRmzNa0scG21kdQ0GvjCQ9hgeRuwytPnk9U0wzFNzUwm8Z_16Nc4YdobeqfOtJshru_XqZkNGSxobZvtwimgNYg2CVYbX25OjDhErdLGpR_sPrTKj61RY5Fak3yKaAJ5FceiOUAe4KIKH3NlwCdhdKsfBT1wwXzE6dwC4Ub3Lp86r1CyvB4IsZbRan0KCsHW8tkAbjttFx_ZYvhihL8gU7MvRxP2GVzZragG0-3lzc4hSoTjFVC3253c9Npx7qOxBYjJiT50y9s6u66okUeZY55OQ1obnvFJRSL6tahQ17vIkI_e_CvxkeDAOB-9RF9uqTDRjc7q1K2D7BXZBibY66Zu89blf308OH-ojjnKDY4TQvrMfWnZN2dJZXXIgQOeOWnxPVbPEQ-xV67bgHcNCz_bULsiIKoHCrhyqIEoy5oFY6yyfFBX_RpN1Jq0K8VwTYt4EV0CKQtSxwytgD5YnA_kjL0xurVK1jV0q_5AQMLgQpXDsGSAPsMOnc5bFqq9WLpNawKhoqOscdRzR4YJ-_-qoCLaDbWO4DWjbz-HHoQ45Kft9km3n1MEuW8VtFwtXGqMDJeIIOJPIm3eyJq2G0oJAFFSEU0rK_VpviX7a-98Ki-QZpslidbtcftgfgpG4KjUc5SbD-NDxl8sZ1C4avCjmliN6cknHSfFnAUZafqRZPnYz26biVOok6xwO1-CIG88XXzPoARMY1bkygi-ddsqbI0pWLIOpzQ_0xQ=s1024')"}}></div>
          <motion.div 
