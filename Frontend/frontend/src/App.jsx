...
const PixIcon = ({ className }) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className={className}><path d="M16.921 2.378a2.915 2.915 0 0 0-2.456-1.378H9.535a2.915 2.915 0 0 0-2.456 1.378L3.375 8.793a2.915 2.915 0 0 0 0 2.95l3.704 6.415a2.915 2.915 0 0 0 2.456 1.378h4.93c1.037 0 1.996-.554 2.456-1.378l3.704-6.415a2.915 2.915 0 0 0 0-2.95l-3.704-6.415Z" fill="#32BCAD"/><path d="M9.824 13.97a3.52 3.52 0 0 1-2.41-.853 2.128 2.128 0 0 1-.58-1.57c.04-.54.296-1.035.704-1.36.438-.35.975-.523 1.554-.5.58-.023 1.116.15 1.554.5.408.325.664.82.704 1.36 0 .54-.236 1.053-.647 1.408-.247.214-.54.37-.87.465l1.63 1.966a.53.53 0 0 1-.82.68l-1.815-2.185v2.247c0 .292-.23.53-.514.53Zm0-3.18c-.287-.01-.55.075-.767.248-.2.158-.325.4-.345.662 0 .26.126.502.327.66.216.173.48.26.766.25.287.01.55-.075.767-.248.2-.158.325-.4.345-.662a.85.85 0 0 0-.327-.66c-.216-.174-.48-.26-.766-.25Z" fill="#fff"/><path d="M14.61 13.97h-.04a.52.52 0 0 1-.49-.52v-4.7a.52.52 0 0 1 1.04 0v4.7a.52.52 0 0 1-.51.52Z" fill="#fff"/></svg>;
const VisaIcon = ({ className }) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className}><path fill="#142688" d="M10.12 16.44 6.72 2.92H3.76C3.38 2.92 2.53 3.1 2.22 3.79L0 14.57h3.45l.66-2.73h3.35l.31 1.48.25 1.12h2.1zM4.77 10.1l1.6-4.32 1 4.32H4.77zm8.35-7.18h-2.1l-3.3 15.52h2.1l3.3-15.52zm5.77 0h-1.63c-1.2 0-2.12.65-2.54 1.63l-4.47 10.63.63 3.26h3.64l.57-3.13h4.47l-.42 1.9h2.09l1.1-12.29-1.44-.01zM16 12.87l1.09-5.18.63 2.95c.35 1.63.29 2.23.29 2.23h-2.01zM24 16.44l-2.09-15.52h-2.22c1.9 4.3 2.87 9.17 2.87 14.12 0 .47-.02.93-.05 1.4h1.49z"/></svg>;
const MastercardIcon = ({ className }) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className}><circle cx="9" cy="12" r="7" fill="#EB001B"/><circle cx="15" cy="12" r="7" fill="#F79E1B" fillOpacity="0.85"/><path d="M12 16.8A7 7 0 0 1 12 7.2a7 7 0 0 1 0 9.6Z" fill="#FF5F00"/></svg>;
const EloIcon = ({ className }) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className}><circle cx="12" cy="12" r="11" fill="#000"/><path d="M8.5 7.5h7c.8 0 1.5.7 1.5 1.5v6c0 .8-.7 1.5-1.5 1.5h-7c-.8 0-1.5-.7-1.5-1.5v-6c0-.8.7-1.5 1.5-1.5z" fill="none"/><path d="M15.5 10a2.5 2.5 0 0 0-2.5-2.5h-4v9h4a2.5 2.5 0 0 0 2.5-2.5v-4z" fill="none" stroke="#fff" strokeWidth="2"/><path d="M9 10h4" stroke="#EF4123" strokeWidth="2" strokeLinecap="round"/><path d="M9 12.5h4" stroke="#00A4E0" strokeWidth="2" strokeLinecap="round"/><path d="M9 15h4" stroke="#FFC20E" strokeWidth="2" strokeLinecap="round"/></svg>;
const BoletoIcon = ({ className }) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className}><rect x="2" y="5" width="20" height="14" rx="2" fill="#fff" stroke="#000" strokeWidth="1.5"/><path d="M5 8h1v8H5zm3 0h2v8H8zm4 0h1v8h-1zm3 0h2v8h-2zm4 0h1v8h-1z" fill="#000"/></svg>;
