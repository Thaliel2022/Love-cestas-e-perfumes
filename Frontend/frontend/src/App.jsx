...
const ProductCard = memo(({ product, onNavigate }) => {
    ...
    return (
        ...
        >
            ...
            {/* ATUALIZAÇÃO: Removido o div com flex-grow e reestruturado para melhor espaçamento vertical */}
            <div className="p-3 flex flex-col justify-between flex-grow">
                <div>
                    <p className="text-xs text-amber-400 font-semibold tracking-wider uppercase">{product.brand}</p>
                    <h4 
                        className="font-bold tracking-normal mt-1 cursor-pointer hover:text-amber-400 text-sm leading-tight h-10 overflow-hidden"
                ...
                <div>
                    <p className="text-xl font-light text-white mt-2">R$ {Number(product.price).toFixed(2)}</p>
