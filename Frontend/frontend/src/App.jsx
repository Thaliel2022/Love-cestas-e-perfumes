    ...
    return (
        <header className="bg-white/80 backdrop-blur-md text-slate-800 shadow-sm sticky top-0 z-40">
            <nav className="container mx-auto px-4 sm:px-6 py-4 flex justify-between items-center">
                <a href="#home" onClick={(e) => { e.preventDefault(); onNavigate('home'); }} className="text-xl font-bold tracking-wide text-amber-600">LovecestasePerfumes</a>
...
const HomePage = ({ onNavigate }) => {
    ...
    const categoryCards = [
        ...
        { name: "Perfumes Femininos", image: "http://googleusercontent.com/image_generation_content/1", filter: "Feminino" },
    ...
    return (
      <>
        <section className="relative h-[80vh] sm:h-[70vh] flex items-center justify-center text-slate-800 bg-gray-100">
          <div className="absolute inset-0 bg-cover bg-center opacity-30" style={{backgroundImage: "url('http://googleusercontent.com/image_generation_content/0')"}}></div>
          <motion.div 
