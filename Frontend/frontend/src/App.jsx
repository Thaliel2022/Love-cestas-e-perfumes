                ...
                {isMobileMenuOpen && (
                    <>
                        ...
                        <motion.div 
                            ...
                            className="fixed top-0 left-0 h-full w-4/5 max-w-sm bg-gray-900 z-[60]"
                        >
                            <div className="absolute top-0 left-0 right-0 h-16 flex justify-between items-center p-4 border-b border-gray-800 bg-gray-900">
