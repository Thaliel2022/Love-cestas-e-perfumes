...
const AdminOrders = () => {
    ...
    return (
        <div>
            <AnimatePresence>
                {editingOrder && (() => {
                    // Determina qual lista de status usar com base no método de envio
                    const availableStatuses = editingOrder.shipping_method === 'Retirar na loja' 
                        ? pickupStatuses 
                        : shippingStatuses;

                    // Garante que o status atual do pedido sempre esteja na lista, para o caso de algum status antigo/removido
            ...
            {/* ... O restante do JSX do AdminOrders (tabela, filtros, etc.) permanece o mesmo ... */}
