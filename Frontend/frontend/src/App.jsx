...
const PixIcon = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className}>
        <path fill="#32BCAD" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-2.5-9.5l-2.8 3.4h2.1l1.7-2.1 1.7 2.1h2.1l-2.8-3.4 2.8-3.4h-2.1l-1.7 2.1-1.7-2.1h-2.1l2.8 3.4z"/>
    </svg>
);
