...
const PixIcon = ({ className }) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className={className}><rect width="256" height="256" fill="none"/><path fill="currentColor" d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm-8.8,112.8a32,32,0,0,1,0-17.6l44-25.4a4,4,0,0,1,5.6,3.2V156a4,4,0,0,1-5.6,3.2Zm51.2,29.6-44-25.4a32,32,0,0,1-16.8,0l-44,25.4A8,8,0,0,1,56,160V96a8,8,0,0,1,9.6-7.2l44,25.4a32,32,0,0,1,16.8,0l44-25.4A8,8,0,0,1,200,96v64a8,8,0,0,1-9.6,7.2Z"/></svg>;
const VisaIcon = ({ className }) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className}><path fill="currentColor" d="M20.34,5.64a2.34,2.34,0,0,0-2.33-2L6,3.54a2.34,2.34,0,0,0-2.33,2L3.58,18.4a2.34,2.34,0,0,0,2.33,2.09L18,20.58a2.34,2.34,0,0,0,2.33-2.09ZM8.2,16.25,6.62,7.26h2.5l1.58,9Zm8.41-3.1-1.12-4.15a5.5,5.5,0,0,0-.23-.88c-.08-.14-.14-.29-.2-.44s-.06-.21-.11-.31a.88.88,0,0,0-.17-.26h0l-.06,0a.69.69,0,0,0-.2-.17l-.14,0h-2.1l3.56,9h2.59l3.8-9h-2.3Z"/></svg>;
const MastercardIcon = ({ className }) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className}><circle cx="8" cy="12" r="7" fill="currentColor" opacity=".8"/><circle cx="16" cy="12" r="7" fill="currentColor" opacity=".8"/><path fill="currentColor" d="M12 5a7 7 0 1 0 0 14a7 7 0 0 0 0-14Z" opacity=".5"/></svg>;
const EloIcon = ({ className }) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className}><path fill="currentColor" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10s10-4.48 10-10S17.52 2 12 2zm-1.09 3.5h2.18c.28 0 .5.22.5.5v.72c0 .28-.22.5-.5.5h-.45c-.83 0-1.5.67-1.5 1.5v1.28c0 .28-.22.5-.5.5h-1c-.28 0-.5-.22-.5-.5V6c0-.28.22-.5.5-.5zm6.59 11c0 .28-.22.5-.5.5H7.5c-.28 0-.5-.22-.5-.5V14c0-.28.22-.5.5-.5h2.27c.83 0 1.5-.67 1.5-1.5v-1.28c0-.28.22-.5.5-.5h1c.28 0 .5.22.5.5v3.28c0 .83.67 1.5 1.5 1.5h2.23c.28 0 .5.22.5.5v1z"/></svg>;
const BoletoIcon = ({ className }) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className}><path fill="currentColor" d="M4 4h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2m2 3v8h1V7H6m2 0v8h1V7H8m2 0v8h1V7h-1m2 0v8h2V7h-2m3 0v8h1V7h-1m2 0v8h1V7h-1Z"/></svg>;
