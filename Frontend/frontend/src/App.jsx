import React, { useState, useEffect, createContext, useContext, useCallback, memo, useRef, useMemo } from 'framer-motion';
...
const OrderStatusTimeline = ({ history, currentStatus, onStatusClick }) => {
    ...
    if (['Cancelado', 'Pagamento Recusado', 'Reembolsado'].includes(currentStatus)) {
        ...
        const specialClasses = colorClasses[specialStatus.color];
        return (
